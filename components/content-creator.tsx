      ...
      <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-none dark:dark-gradient-shadow-lg bg-white dark:bg-zinc-900">
        <div className="mb-4">
          <Textarea
            ...
            className="min-h-[150px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-4 text-lg bg-white dark:bg-zinc-800"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <Button
            variant="outline"
            className="border-2 border-black dark:dark-rounded-gradient-border rounded-xl font-bold flex gap-2 h-12"
          >
        ...
        {type === "post" && (
          <div className="space-y-4">
            ...
            <Tabs defaultValue="filters">
              <TabsList className="bg-gray-100 dark:bg-zinc-800/50 border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-1 mb-4 w-full">
                <TabsTrigger
                  value="filters"
                  className="rounded-lg data-[state=active]:bg-black data-[state=active]:text-white dark:data-[state=active]:bg-gradient-to-r dark:data-[state=active]:from-gradient-pink dark:data-[state=active]:to-gradient-purple font-bold"
                >
                  Filters
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="hashtags">
                <Textarea
                  ...
                  className="min-h-[100px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-4 bg-white dark:bg-zinc-800"
                />
              </TabsContent>
        ...
        {type === "video" && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-black dark:dark-rounded-gradient-border rounded-xl p-8 text-center">
            ...
            <div>
              ...
              <Textarea
                ...
                className="min-h-[60px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-4 bg-white dark:bg-zinc-800"
              />
            </div>
          </div>
        )}
        ...
        <div className="mt-6 lg:hidden">
          <Collapsible>
            <CollapsibleTrigger className="flex items-center justify-between w-full p-3 bg-black text-white dark:bg-gradient-to-r dark:from-gradient-pink dark:to-gradient-purple rounded-xl font-bold">
              <span>Platforms</span>
              <ChevronDown className="h-5 w-5" />
            </CollapsibleTrigger>
            <CollapsibleContent className="mt-3 space-y-3 p-3 border-2 border-black dark:dark-rounded-gradient-border rounded-xl bg-white dark:bg-zinc-900">
              <div className="flex items-center justify-between">

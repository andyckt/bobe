...
import { ChevronRight, MapPin, Star, Clock, Music, Wine, GlassWater, ExternalLink, Building2, Instagram, Linkedin, Twitter, Youtube, Plus } from "lucide-react"
...
export default function BarTabContent() {
  return (
    <div>
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 text-center">SHANGHAI BARS</h2>
      
      <div className="mb-8">
        <h3 className="text-xl sm:text-2xl font-black mb-4">CONNECTED ACCOUNTS</h3>
      ...
      <div className="mb-8">
        <h3 className="text-xl sm:text-2xl font-black mb-4">CONTENT STUDIO</h3>
        <StudioSelector />
      </div>

      <div className="mb-8">
        <h3 className="text-xl sm:text-2xl font-black mb-6">FEATURED BARS</h3>
      ...
      <div>
        <h3 className="text-xl sm:text-2xl font-black mb-6">BROWSE BY CATEGORY</h3>

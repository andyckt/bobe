...
export default function AudioStudioPage() {
  ...
  useEffect(() => {
    ...
    ctx.fillStyle = "#000" // Color for light mode waveform bars

    // In dark mode, use a lighter color for waveform bars
    if (document.documentElement.classList.contains("dark")) {
      ctx.fillStyle = "#FFF" // White for dark mode
    }
  ...
  }, [isPlaying, audioFile]) // Redraw if isPlaying or audioFile changes, for dynamic effect
      ...
      <div className="grid lg:grid-cols-[1fr_350px] gap-6">
        <div className="space-y-6">
          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            ...
            <div className="border-4 border-dashed border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-8 text-center mb-4">
              {audioFile ? (
                <div>
          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            ...
            <div className="bg-white/50 dark:bg-zinc-800/30 border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4">
              <div className="bg-white dark:bg-zinc-900 border-2 border-black dark:dark-rounded-gradient-border rounded-lg p-2">

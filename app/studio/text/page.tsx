          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            <Tabs defaultValue="edit">
              ...
              <TabsContent value="edit">
                ...
                <Textarea
                  className="min-h-[300px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-4 text-lg mb-4"
                ...
                <div className="space-y-4">
                  ...
                  {generatedText && (
                    <div className="mt-4">
                      ...
                      <div className="border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-4 bg-white/50 dark:bg-zinc-800/30">
                        <p>{generatedText}</p>
                      </div>
            ...
            <div className="p-4 bg-white dark:bg-zinc-900">
              <Tabs defaultValue="format">
                ...
                <TabsContent value="analyze" className="space-y-4">
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-2 border-black dark:dark-rounded-gradient-border rounded-xl font-bold mt-4"
                  >

    ...
    <div>
      ...
      <div className="grid lg:grid-cols-[1fr_350px] gap-6">
        <div className="space-y-6">
          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            <h3 className="text-xl font-bold mb-4">Video Source</h3>
            {videoFile ? (
              <div className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl overflow-hidden bg-black mb-4">
                <video ref={videoRef} className="w-full aspect-video" controls={false} />
              </div>
            ) : (
              <div className="border-4 border-dashed border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-8 text-center mb-4 aspect-video flex flex-col items-center justify-center">
                <Film className="h-12 w-12 sm:h-16 sm:w-16 mb-4 opacity-50" />
                <p className="mb-4">Drop your video file here or</p>
                <Button
                  variant="outline"
                  className="border-2 border-black dark:dark-rounded-gradient-border rounded-xl font-bold"
          ...
          {videoFile && (
            <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
              ...
              <div className="bg-white/50 dark:bg-zinc-800/30 border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4">
                <div className="bg-white dark:bg-zinc-900 border-2 border-black dark:dark-rounded-gradient-border rounded-lg p-2 h-[80px] sm:h-[100px] mb-4">
                  {/* Timeline tracks would go here */}
                  <div className="flex h-full">
                    <div className="w-12 sm:w-16 h-full border-r-2 border-black dark:border-zinc-700 flex flex-col justify-center items-center">
                      <Film className="h-4 w-4 sm:h-5 sm:w-5" />
                      <span className="text-xs font-bold mt-1">Video</span>
                    </div>
                    <div className="flex-1 bg-gray-100 dark:bg-zinc-800 relative">
                      <div className="absolute top-0 left-[20%] bottom-0 w-[60%] bg-blue-200 dark:bg-blue-700 border-2 border-blue-400 dark:border-blue-500 rounded-md flex items-center justify-center">
                        <span className="text-xs font-bold text-blue-800 dark:text-blue-200">Main Clip</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2">
                  <Button
                    variant="outline"
                    className="border-2 border-black dark:dark-rounded-gradient-border rounded-xl h-10 w-10 p-0"
                  >
                    <SkipBack className="h-4 w-4" />
                  </Button>
                  <Button
                    className="bg-black hover:bg-black/80 text-white dark:bg-gradient-to-r dark:from-gradient-pink dark:to-gradient-purple dark:text-black dark:hover:brightness-110 rounded-xl border-2 border-black dark:dark-rounded-gradient-border h-12 w-12 p-0"
                    onClick={togglePlay}
                  >
            ...
            <div className="space-y-4">
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-[80px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl"
                  value={aiPrompt}
              ...
              <div className="flex justify-end">
                <Button
                  className="bg-black hover:bg-black/80 text-white dark:bg-gradient-to-r dark:from-gradient-pink dark:to-gradient-purple dark:text-black dark:hover:brightness-110 rounded-xl border-2 border-black dark:dark-rounded-gradient-border font-bold"
              ...
              {aiResponse && (
                <div className="mt-4 p-4 bg-white/50 dark:bg-zinc-800/30 border-2 border-black dark:dark-rounded-gradient-border rounded-xl">
          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            ...
            <div className="p-4 bg-white dark:bg-zinc-900">
              <Tabs defaultValue="edit">
                <TabsList className="bg-white/50 dark:bg-zinc-800/30 border-2 border-black dark:dark-rounded-gradient-border rounded-xl p-1 mb-4 w-full">
                  <TabsTrigger
                    value="edit"
                ...
                <TabsContent value="edit" className="space-y-4">
                  <Button
                    variant="outline"
                    className="w-full border-2 border-black dark:dark-rounded-gradient-border rounded-xl font-bold flex gap-2"
                  >
                ...
                <TabsContent value="text" className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select defaultValue="english">
                      <SelectTrigger className="border-2 border-black dark:dark-rounded-gradient-border rounded-xl">
          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            ...
            <div className="p-4 bg-white dark:bg-zinc-900 space-y-4">
              ...
              <div className="pt-2 space-y-3">
                <Button className="w-full bg-black hover:bg-black/80 text-white dark:bg-gradient-to-r dark:from-gradient-pink dark:to-gradient-purple dark:text-black dark:hover:brightness-110 rounded-xl border-2 border-black dark:dark-rounded-gradient-border font-bold">
                  <Save className="h-4 w-4 mr-2" /> Save Project
                </Button>
                <Button
                  variant="outline"
                  className="w-full border-2 border-black dark:dark-rounded-gradient-border rounded-xl font-bold"
                >

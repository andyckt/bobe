          ...
          <Card className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl p-4 sm:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_#ec4899]">
            <Tabs defaultValue="upload">
              ...
              <TabsContent value="upload">
                ...
                {imagePreview ? (
                  <div className="border-4 border-black dark:dark-rounded-gradient-border rounded-xl overflow-hidden bg-gray-100 dark:bg-zinc-800 flex items-center justify-center mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Textarea
                      ...
                      className="min-h-[100px] border-2 border-black dark:dark-rounded-gradient-border rounded-xl"
                      value={aiPrompt}

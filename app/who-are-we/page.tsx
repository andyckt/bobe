...
export default function WhoAreWePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-zinc-900 dark:to-black p-2 sm:p-4 md:p-8">
        ...
        <header className="border-b-4 border-black dark:dark-gradient-border p-4 sm:p-6 bg-white/40 dark:bg-transparent backdrop-blur-md">
          <div className="flex justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight">WHO WE ARE</h1>
            </div>
            <ThemeToggle />
          </div>
        </header>
